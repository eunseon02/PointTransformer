...
class Train():
    def __init__(self, args):
        ...
        self.model = PointCloud3DCNN(self.batch_size, in_channels=4, out_channels=4, dimension=4, n_depth=4).to(self.device)
